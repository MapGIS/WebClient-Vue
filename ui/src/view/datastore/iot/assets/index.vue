    ...
    <ul v-else class="mp-file-previer-container">
      ...
      >
        <div class="item-content" @click="preview(file)">
          ...
          <mapgis-ui-tooltip>
            <template slot="title"> {{ file.name }} </template>
            <span>{{ file.name }}</span>
          </mapgis-ui-tooltip>
        </div>
      </li>
...
<script>
import image from "../../../assets/images/image-relation-text/图片@3x.png";
import video from "../../../assets/images/image-relation-text/视频@3x.png";
import text from "../../../assets/images/image-relation-text/txt@3x.png";
import other from "../../../assets/images/image-relation-text/其他格式@3x.png";
import preview from "./preivew.vue";
