...
function geometryToXmlGeoserver(geometry,me) {
    ...
    xml += "<gml:pos>" + geometry.coordinates[0] + " " + geometry.coordinates[1] + "</gml:pos>"
...
function geometryToXml(geometry,me) {
    ...
    if(geometry.type === "Polygon"){
        ...
        xml += "<pointMember>";
        for (let i = 0;i < geometry.coordinates.length;i++){
            xml += "<Point><coordinates>" + geometry.coordinates[i].join(",") + "</coordinates></Point>";
        }
        xml += "</pointMember>";
            ...
            if(ast.operator === "OR"){
                ...
                if(comparisonOperators.hasOwnProperty(ast.operator)){
                    ...
                    if(ast.operator === "BETWEEN"){
                        xml += "<LowerBoundary><Literal>" + ast.right.value[0].value + "</Literal></LowerBoundary>"
                        xml += "<UpperBoundary><Literal>" + ast.right.value[1].value + "</Literal></UpperBoundary>"
                    }else {
