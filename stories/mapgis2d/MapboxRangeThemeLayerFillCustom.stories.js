...
export default {
  title: "二维/图层/专题图/分段专题图自定义样式/定义整体样式/多边形",
  argTypes: {
    type: {
    ...
    layerStyle: {
      description: "渐变样式，有如下参数：<br>" +
          ...
          "3、<span class='storybook-span'>outlineWidth</span>：多边形外边线宽度，默认为1<br>" +
          "4、<span class='storybook-span'>outlineColor</span>：多边形外边线颜色，16进制或rgb颜色，默认为#000000<br>" +
          "5、<span class='storybook-span'>outlineOpacity</span>：多边形外边线透明度，默认为1，0~1之间的小数，0表示完全透明，1表示不透明",
      table:{
        defaultValue: { summary: 'null' },
      }
    }
