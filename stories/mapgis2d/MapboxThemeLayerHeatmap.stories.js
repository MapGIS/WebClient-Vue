  ...
  argTypes: {
    ...
    themeOption: {
      description:  "创建专题图所需要的参数，有如下值：<br>" +
          ...
          "有如下值：<br>" +
          "1、<span class='storybook-span'>color</span>：热力颜色，例如：#9999FF,#99FFFF,#FF9999,#FFFF99，以逗号分割表示从里到外的渐变颜色<br>" +
          "2、<span class='storybook-span'>radius</span>：热力半径，半径越大，则热力聚合越紧密，反之则热力聚合月稀疏",
      table:{
        defaultValue: { summary: 'null' },
      }
    }
