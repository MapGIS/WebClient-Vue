...
export default {
  ...
  argTypes: {
    ...
    url: `http://${window.webclient.igsIp}:${window.webclient.igsPort}/igs/rest/mrms/docs/wuhan_WFS_4326`,
  },
};
...
const Template = (args, { argTypes }) => ({
  ...
  template: `<mapgis-web-map crs="EPSG:4326" :center="[(113.69534616+115.07406408)/2, (29.969811+31.36330098)/2]" :zoom="8" style="height:95vh">
