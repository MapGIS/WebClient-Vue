  ...
  argTypes: {
    ...
    themeOptions: {
      description:  "专题图样式，包含专题图图层样式、分段样式以及高亮样式，样式如下：<br>" +
          ...
          "1.3、<span class='storybook-span'>radius</span>：点半径，默认为6<br>" +
          "1.4、<span class='storybook-span'>outlineColor</span>：点的外边线颜色，16进制或rgb颜色，默认为#000000<br>" +
          "1.5、<span class='storybook-span'>outlineOpacity</span>：点的外边线透明度，默认为1，0~1之间的小数，0表示完全透明，1表示不透明<br>" +
          "1.6、<span class='storybook-span'>outlineWidth</span>：点的外边线宽度，默认为1" +
