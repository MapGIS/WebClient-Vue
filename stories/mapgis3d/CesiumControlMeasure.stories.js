...
const Template = (args, { argTypes }) => ({
  ...
  template: `
    <mapgis-web-scene style="height:95vh"
      ...
      <mapgis-3d-scene-layer :url="$props.m3durl"> </mapgis-3d-scene-layer>
      <div
