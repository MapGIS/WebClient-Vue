...
Supercluster.prototype.getLeaves = function getLeaves(
  clusterId,
  limit,
  offset
) {
...
Supercluster.prototype.getClusterExpansionZoom =
...
Supercluster.prototype._appendLeaves = function _appendLeaves(
  result,
  clusterId,
  limit,
  offset,
...
Supercluster.prototype._addTileFeatures = function _addTileFeatures(
  ids,
  points,
  x,
  y,
